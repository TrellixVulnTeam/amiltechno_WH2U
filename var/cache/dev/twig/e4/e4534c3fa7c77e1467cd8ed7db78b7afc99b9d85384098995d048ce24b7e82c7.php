...
class __TwigTemplate_1cb059fa46bddc9b02fb8f3f38fe2ec967edc2c2e25c0839b681f06f7405cd64 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"example-wrapper\">
    <h1>Hello My Friend Get ";
        // line 12
        echo twig_escape_filter($this->env, (isset($context["RegisterController"]) || array_key_exists("RegisterController", $context) ? $context["RegisterController"] : (function () { throw new RuntimeError('Variable "RegisterController" does not exist.', 12, $this->source); })()), "html", null, true);
        echo "ed ✅</h1>
    ...
    ";
        // line 17
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 17, $this->source); })()), "username", [], "any", false, false, false, 17), 'widget');
        echo "
    </div>
...
";
    ...
    {
        return array (  116 => 20,  110 => 17,  106 => 16,  101 => 14,  96 => 12,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<div class=\"example-wrapper\">
    <h1>Hello My Friend Get {{ RegisterController }}ed ✅</h1>
...
{% endblock %}
", "register/index.html.twig", "C:\\wamp64\\www\\monapplisymf\\templates\\register\\index.html.twig");
    }
}
